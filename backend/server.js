...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/train-traffic-optimization';
...
mongoose.connect(MONGODB_URI)
  ...
  .catch((error) => {
    ...
    server.listen(PORT, () => {
      console.log(`🚂 Train Traffic Optimization API running on port ${PORT} (No Database)`);
      console.log(`📊 Health check: http://localhost:${PORT}/api/health`);
    });
  });
